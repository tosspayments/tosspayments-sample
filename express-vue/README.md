...
| 제품                        | 링크                                                |
| --------------------------- | --------------------------------------------------- |
| 결제위젯 한눈에 보기        | http://localhost:3000/widget                        |
| 결제위젯 (주문서형)         | http://localhost:3000/widget/checkout               |
| 결제위젯 (결제창형)         | http://localhost:3000/widget/checkout-window        |
