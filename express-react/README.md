...
토스페이먼츠 JavaScript SDK로 결제 과정을 구현한 Express + React 샘플 프로젝트입니다. 자세한 연동 방법과 결제 과정은 [공식 연동 문서](https://docs.tosspayments.com/guides/standard/integration)에서 확인하세요.
...
- **클라이언트 키**: `pages/Checkout.jsx`, `pages/payment/PaymentCheckout.jsx`, `pages/brandpay/BrandpayCheckout.jsx` 파일에 있는 `clientKey`를 내 결제위젯 클라이언트 키로 수정하세요.
