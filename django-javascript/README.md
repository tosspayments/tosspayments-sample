...
| 제품                        | 링크                                                    |
| --------------------------- | ------------------------------------------------------- |
| 결제위젯 한눈에 보기        | http://127.0.0.1:8000/                                  |
| 결제위젯 (주문서형)         | http://127.0.0.1:8000/widget/checkout                   |
| 결제위젯 (결제창형)         | http://127.0.0.1:8000/widget/checkout-window            |
| 결제창(일반결제/정기결제)   | http://127.0.0.1:8000/payment/checkout                  |
| 브랜드페이                  | http://127.0.0.1:8000/brandpay/checkout                 |
