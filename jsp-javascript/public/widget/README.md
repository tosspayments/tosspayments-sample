...
2. 클론한 레포지토리의 `/jsp-javascipt/public/widget` 폴더를 Tomcat의 `webapp` 폴더에 넣어주세요.

3. Tomcat을 실행하고 http://localhost:{PORT_NUMBER}/jsp/index.html 에서 샘플 프로젝트를 확인하세요.

| 제품                        | 링크                                                             |
| --------------------------- | ---------------------------------------------------------------- |
| 결제위젯 한눈에 보기        | http://localhost:{PORT_NUMBER}/widget/index.html                 |
| 결제위젯 (주문서형)         | http://localhost:{PORT_NUMBER}/widget/checkout.html              |
| 결제위젯 (결제창형)         | http://localhost:{PORT_NUMBER}/widget/checkout-window.html       |
