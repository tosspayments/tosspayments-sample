<template>
  <div class="wrapper">
    <div
      class="box_section"
      style="padding: 40px 30px 50px 30px; margin-top: 30px; margin-bottom: 50px; display: flex; flex-direction: column"
    >
      <button class="button" style="margin-top: 30px" @click="requestPayment">결제하기</button>
      <button class="button" style="margin-top: 30px" @click="addPaymentMethod">결제수단추가</button>
      <button class="button" style="margin-top: 30px" @click="changeOneTouchPay">원터치페이설정변경</button>
      <button class="button" style="margin-top: 30px" @click="changePassword">비밀번호변경</button>
      <button class="button" style="margin-top: 30px" @click="isOneTouchPayEnabled">원터치결제사용가능여부 조회</button>
      <button class="button" style="margin-top: 30px" @click="openSettings">브랜드페이 설정 열기</button>
    </div>
  </div>
</template>
