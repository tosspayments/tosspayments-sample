...
| 제품                        | 링크                                                              |
| --------------------------- | ----------------------------------------------------------------- |
| 결제위젯 한눈에 보기        | http://localhost:4000/public/widget/index.html                    |
| 결제위젯 (주문서형)         | http://localhost:4000/public/widget/checkout.html                 |
| 결제위젯 (결제창형)         | http://localhost:4000/public/widget/checkout-window.html          |
